    ...
    return (
        <section id="about" className="py-20">
            <div className="container mx-auto text-center">
                ...
                <p className="text-xl mb-8">I'm a qualifi and skill developer with learning and experience. I always code with an eye for detail. I'm readly to learn new thing and develop myself.</p>
