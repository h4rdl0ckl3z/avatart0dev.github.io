        ...
        <section id="about" className="py-20">
            <div className="container mx-auto text-center">
                ...
                <p className="text-xl mb-8">
                    I am a qualified and skilled developer with learning and experience.
                    I always code with an eye for detail.
                    I am ready to learn new things and develop myself.
                </p>
