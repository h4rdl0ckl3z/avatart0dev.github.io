...
export const SectionWork = () => {
    ...
    const events = [
        { year: 'Full Stack Developer | 11/12/2024', title: 'Elegance Consultant Co.,Ltd.', description: 'Full stack developer with devops, Provide Trial', details: ['Learning Tech'] },
